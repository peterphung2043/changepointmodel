...
def test_extras_filter_shape_good_models(dummy_result_for_filter_extra_good_for_shape_test):
...
def test_extras_filter_shape_bad_models(dummy_result_for_filter_extra_bad_for_shape_test):
...
def test_extras_filter_dpop_good_models(dummy_result_for_filter_extra_good_for_dpop_test):
