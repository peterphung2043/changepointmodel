...
def test_filter_best_score_with_good_model(dummy_result_for_filter_good):
    ...
    filter_dict = {'which': FilterWhichEnum.r2, 'how': FilterHowEnum.best_score, 'extras': False}
...
def test_filter_best_score_with_mixed_models(dummy_result_for_filter_bad,
...
def test_filter_threshold_ok_with_good_model(dummy_result_for_filter_good):
    ...
    filter_dict = {'which': FilterWhichEnum.r2, 'how': FilterHowEnum.threshold_ok, 'extras': False}
    filter_obj = filter_.ChangepointEstimatorFilter(**filter_dict)
    results = filter_obj.filtered(dummy_result_for_filter_good)
...
def test_filter_threshold_ok_with_mixed_model(dummy_result_for_filter_bad, 
                                            dummy_result_for_filter_good):
...
def test_filter_threshold_ok_first_is_best_with_good_model(dummy_result_for_filter_good):

    filter_dict = {'which': FilterWhichEnum.r2, 'how': FilterHowEnum.threshold_ok_first_is_best, 'extras': False}
    filter_obj = filter_.ChangepointEstimatorFilter(**filter_dict)
    results = filter_obj.filtered(dummy_result_for_filter_good)
    assert len(results) == 1
    best_result = results.pop()
...
def test_filter_threshold_ok_first_is_best_with_mixed_model(dummy_result_for_filter_bad, 
                                            dummy_result_for_filter_good):
